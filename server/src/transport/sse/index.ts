...
app.get("/", (_: Request, res: Response) => {
    res.send(`
        <html>
            <head><title>Weather MCP Server</title></head>
            <body>
                <h1>Weather MCP Server</h1>
                <p>This is a Model Context Protocol server for weather data.</p>
                <p>Connect to /sse for Server-Sent Events and post messages to /api/messages</p>
            </body>
        </html>
    `);
});
